...
def main_menu():
    ...
    # EXACT REPLICA OF ORIGINAL BOT (second photo) - pure green buttons
    # Telegram me background color API se set nahi hota, ye client theme se green dikhta hai
    # Original bot me bhi plain text hai, theme se green/red/blue banta hai
